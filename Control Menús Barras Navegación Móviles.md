...
Se definir un tamaño máximo para el contenedor de la imagen en CSS estableciendo un tamaño máximo en píxeles para la anchura y altura del contenedor. Por ejemplo:
```css
